...
| `finance.py` | ~150 | akshare (THS财务摘要) + 新浪(利润表) | ROE/毛利率/净利率/负债率/营收增速/净利增速/EPS/每股净资产/经营现金流/分红历史/机构盈利预测/存货周转/应收周转/研发费用+占比/多期历史数据 | ✅ |
...
| `fundamental.py` | ~300 | 财务指标 + 分红 + 预测 | 盈利能力/财务健康/成长性/现金流质量/周转效率/多期趋势/研发占比/综合评分(100分制A-D评级), 信号/警告列表 | ✅ |
